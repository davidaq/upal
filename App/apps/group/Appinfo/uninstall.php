...
$sql = array(
    ...
    "DROP TABLE IF EXISTS `{$db_prefix}group_weibo;",
    "DROP TABLE IF EXISTS `{$db_prefix}group_weibo_atme;",
    "DROP TABLE IF EXISTS `{$db_prefix}group_weibo_comment;",
    "DROP TABLE IF EXISTS `{$db_prefix}group_weibo_favorite;",
    "DROP TABLE IF EXISTS `{$db_prefix}group_weibo_topic;",
	// ts_system_data数据
