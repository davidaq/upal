...
<div class="content"><!-- 内容 begin  -->
  <div class="user_app">
	<div class="celerity_menu">
		<ul>
		<li><a href="<?php echo U('home/Square/index');?>" <?php if('index' == ACTION_NAME): ?>class="on"<?php endif; ?>
		  ><span class="ico_side ico_square<?php if('index' == ACTION_NAME): ?>_on<?php endif; ?>"></span><?php echo L('广场首页');?></a></li>
		<li><a href="<?php echo U('home/Square/top');?>" <?php if('top' == ACTION_NAME): ?>class="on"<?php endif; ?>
		  ><span class="ico_side ico_billboard"></span><?php echo L('风云榜');?></a></li>
		<li><a href="<?php echo U('home/Square/star');?>" <?php if('star' == ACTION_NAME): ?>class="on"<?php endif; ?>
		  ><span class="ico_side ico_hall<?php if('star' == ACTION_NAME): ?>_on<?php endif; ?>"></span><?php echo L('名人堂');?></a></li>
		</ul>
	</div>
	<div class="celerity_menu app_line">
		<ul>
			<?php if(is_array($expend_menu)): ?><?php $i = 0;?><?php $__LIST__ = $expend_menu?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><li><a href="<?php echo U('home/Square/' . $vo['act'], $vo['param']);?>" <?php if(ACTION_NAME == $vo['act']): ?>class="on"<?php endif; ?>
				  ><span class="ico_side ico_<?php echo ($vo['act']); ?><?php if($vo['act'] == ACTION_NAME): ?>_on<?php endif; ?>"></span><?php echo ($vo['name']); ?></a></li><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
		</ul>
	</div>
</div>
        ...
        <?php if(is_array($topfollow)): ?><?php $i = 0;?><?php $__LIST__ = $topfollow?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><?php if($key>2){ $class='no'; }else{ $class='no top'.($key+1); } ?>
          <li>
            ...
            <div>
                ...
                <p><span><?php echo ($vo["count"]); ?></span><?php echo L('粉丝数');?></span>
            </div>
	...
	<?php } ?>
      ...
      <div class="mainbox_C main_pad" >
		...
		<div class="Hotspot_box">
			<?php if(($mid)  >  "0"): ?><div class="hotspot_tit"><span><a href="javascript:void(0)" onclick="weibo.quickpublish('#<?php echo (addslashes(str_replace('"','&quot;',$aboutkey))); ?># ')"><?php echo L('我也说几句');?>>></a></span><strong><?php echo L('今日看点');?>:</strong><?php echo L('大家一起聊“');?><a href="<?php echo U('home/User/topics',array('k'=>$aboutkey));?>"><?php echo ($aboutkey); ?></a><?php echo L('”吧');?></div><?php endif; ?>
			<div class="topic">
            ...
            <?php if(is_array($userlist)): ?><?php $i = 0;?><?php $__LIST__ = $userlist?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><div class="topic_user" <?php if($i > 1){echo 'style="display:none;"';}else{echo 'style="display:block;"';} ?>>
	              ...
	              <div class="dd left" style="width:480px;_width:470px">
	                ...
	                <p><?php echo ($vo["userinfo"]["location"]); ?> <a href="<?php echo U('home/Space/follow',array('uid'=>$vo['uid'],'type'=>'follower'));?>"><?php echo L('粉丝数');?>:<?php echo (intval($vo["follower"])); ?></a></p>
        ...
        <div class="laSOSO">
         <div class="sosobox">
            ...
            <input type="button" onclick="s_search('topic')" value="<?php echo L('搜微博');?>" class="btn_b">
            <input type="button" onclick="s_search('user')" value="<?php echo L('搜人');?>" class="btn_b"></p>
            <p class="reci">
            <span class="cGray2"><?php echo L('热词');?>:</span>
            <?php if(is_array($hotkeys)): ?><?php $i = 0;?><?php $__LIST__ = $hotkeys?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$hk): ?><?php ++$i;?><?php $mod = ($i % 2 )?><a href="<?php echo U('home/user/search',array('k'=>urlencode($hk['name'])));?>"><?php echo (getShort($hk["name"],10)); ?></a>&nbsp;&nbsp;<?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?></p>
          </div>
        </div>
        
        <?php if($hotUser): ?><div class="tab-menu">
            <ul>
              <li><a class="feed_item on"  href="javascript:void(0)" ><span><?php echo L('活跃用户');?></span></a></li>
            </ul>
          </div>
		...
		<!--名人推荐-->
        <?php if($star_list): ?><div class="mod-star clearfix">
          <div class="tab-menu">
              <ul>
                  <span class="right"><a href="<?php echo U('home/Square/star');?>" target="_blank"><?php echo L('more');?>&raquo;</a></span>
                  <li><a class="feed_item on"  href="javascript:void(0)" ><span><?php echo L('名人推荐');?></span></a></li>
              </ul>
          </div>
          <div id="star_list" class="star_list"><img src="__THEME__/images/icon_waiting.gif" width="20" style="margin:33px 50% 0 50%;" /></div>
	    </div><?php endif; ?>
		<!--//名人推荐-->
