    ...
    <div class="mainbox boxspace">
      <div class="mainbox_appR">
        <div style="padding:10px;">
          <p class="pb10"><?php echo L('还未开通?赶快注册一个!');?></p>
      ...
      <div class="mainbox_appC boxspace_L">
        ...
        <div class="left" style="width:100%">
          <h2 class="cBlue"><strong><?php echo L('快速登录');?></strong></h2>
          </div>
          <form action="<?php echo U('home/Public/doLogin');?>" method="post" onsubmit="return checkVerify(this)">
            ...
            <ul class="form_list">
              ...
              <?php if(($login_verify_on)  ==  "1"): ?><li class="form_li" style="position:relative">
                <div class="reg_li_1"><?php echo L('验证码');?>:</div>
                <div class="reg_li_2">
                  <input type="text" class="text35" style="width:100px;vertical-align:middle;" id="verify" name="verify"  value="" />
                  <img src="__ROOT__/public/captcha.php" id="verifyimg" alt="<?php echo L('换一张');?>" style="cursor: pointer;vertical-align:middle;" onclick="changeverify()" /> 
                </div>
                <div class="reg_li_3">
                  &nbsp;&nbsp;
                  <a href="###" onclick="changeverify()"><?php echo L('换一换');?></a>
                </div>
              </li><?php endif; ?>
              <li class="form_li" style="position:relative">
                <div class="reg_li_1">&nbsp;</div>
                <div class="reg_li_2">
                  <label><input name="remember" type="checkbox" value="1" style="vertical-align:middle"/> <?php echo L('记住登录状态');?></label>
                   | <a class="fuc0" target="_blank" href="<?php echo U('home/Public/sendPassword');?>"><?php echo L('忘记密码？');?></a>
                </div>
              </li>
              <li class="form_li">
                <div class="reg_li_1">&nbsp;</div>
                <div class="reg_li_2"> 
				        <input type="submit" class="btn_green_w121" value="<?php echo L('快速登录');?>">
                </div>
              </li>
            </ul>
          </form>
...
function  checkVerify(form){
  ...
  if("undefined" != typeof(form.email) && form.email.value == ''){
    ui.error("<?php echo L('帐号不能为空！');?>");
    return false;
  }
  if(form.password.value == ''){
    ui.error("<?php echo L('password_notnull');?>");
    return false;
  }
  if(form.verify.value == ''){
    ui.error("<?php echo L('验证码不能为空！');?>");
    return false;
  }
  $.post("<?php echo U('home/Public/isVerifyAvailableLogin');?>", {verify:verify}, function(msg) {
    if(msg == 'success') {
      ...
      ui.error("<?php echo L('验证码错误，请重新输入');?>");
    }
  });
  return false;
}
